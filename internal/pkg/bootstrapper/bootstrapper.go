...
// // Apply applies a set of resources to a Kubernetes cluster.
// func (b *Bootstrapper) Apply(resources ...*unstructured.Unstructured) error {
...
// // Destroy removes a set of resources from a Kubernetes cluster.
// func (b *Bootstrapper) Destroy(resources ...*unstructured.Unstructured) error {
